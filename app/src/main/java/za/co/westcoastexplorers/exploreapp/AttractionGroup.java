...
public class AttractionGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attractiongroup);
        ...
        mItems = FireBaseController.getInstance().getAttractions("group", group);
        if (mItems != null) {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        if (menu.findItem(R.id.action_search) != null) {
            ...
            ((EditText)searchView.findViewById(android.support.v7.appcompat.R.id.search_src_text)).setTextColor(ContextCompat.getColor(AttractionGroup.this, android.R.color.primary_text_dark));
